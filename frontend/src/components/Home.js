...
const Home = ({match}) => {
  ...
  const { loading, products, errors, productsCount, resPerPage, filteredProductsCount } = useSelector(
  ...
  }, [dispatch, errors, alert, currentPage, keyword, price, category, rating]);
